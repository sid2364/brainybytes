...
class SampleLexer {
  ...
  private static final String ZZ_CMAP_BLOCKS_PACKED_0 =
    "\12\0\1\1\2\0\1\2\42\0\12\3\7\0\32\3"+
    "\6\0\32\3\u0185\0";
  ...
  private static final String ZZ_ROWMAP_PACKED_0 =
    "\0\0\0\4\0\10\0\10\0\14\0\20\0\20";
  ...
  private static final String ZZ_TRANS_PACKED_0 =
    "\1\3\1\4\1\5\1\6\4\3\5\0\1\4\5\0"+
    "\1\7";
...
// After the last line, check if it contained alphanumeric content
  ...
  public static void main(String[] argv) {
    if (argv.length == 0) {
      System.out.println("Usage : java SampleLexer [ --encoding <name> ] <inputfile(s)>");
    }
    else {
      int firstFilePos = 0;
      ...
      for (int i = firstFilePos; i < argv.length; i++) {
        SampleLexer scanner = null;
        java.io.FileInputStream stream = null;
        java.io.Reader reader = null;
        try {
          stream = new java.io.FileInputStream(argv[i]);
          reader = new java.io.InputStreamReader(stream, encodingName);
          scanner = new SampleLexer(reader);
